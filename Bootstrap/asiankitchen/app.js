...
addButton = () => {
    ...
    btnContainer.innerHTML = createButton("All") + " " + createButton("Korea") + " "
        + createButton("Japan") + " " + createButton("China");

    document.getElementById('All').addEventListener("click", addFoodsAll)
    document.getElementById('Korea').addEventListener("click", koreanMENU)
    document.getElementById('Japan').addEventListener("click", japanMenu)
    document.getElementById('China').addEventListener("click", chinaMenu)
}
...
addFoodsAll = () => {
    section.innerHTML = ""
    menu.forEach(food => {
        section.innerHTML += (" " + foodCreator(food))
    });
}
